...
import daisyImage from '/FlowerGrdi.png'
...
function App() {
  ...
  return (
    <>
      ...
      <Hero type={HeroNames.HeroMain_2} image={moonImage} primaryText='Flores invaluables, momentos inolvidables' secondaryText='Nuestros diseños están hechos para contar una historia' thirdText='Déjanos contar tu historia' cta1='Contáctanos' cta1Link='' ></Hero>
    </>
  )
}
